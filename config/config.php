...
$conf['settings']['default.language'] = 'it_IT';                // find your language in the lang directory
$conf['settings']['script.url'] = 'http://localhost/goflotte/Web';   	// public URL to the Web directory of this instance. this is the URL that appears when you are logging in. leave http: or https: off to auto-detect
...
$conf['settings']['inactivity.timeout'] = '480';     			// minutes before the user is automatically logged out
...
$conf['settings']['database']['password'] = 'cv56py';
...
$conf['settings']['phpmailer']['smtp.host'] = 'smtp.orcart.com';               // 'smtp.company.com'
...
$conf['settings']['phpmailer']['smtp.username'] = 'gestioneflotte_demo@orcart.com';
$conf['settings']['phpmailer']['smtp.password'] = 'gestioneflottedemo';
 ...
 */
$conf['settings']['install.password'] = 'cv56py';
/**
 * Pages
 */
